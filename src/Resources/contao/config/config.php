...
use Tastaturberuf\AnyAccessBundle\Contao\Hooks\GlobalIpAccess;
 ...
 * Default settings
 */
if ( !Config::get('cookieSessionTime') )
{
    Config::set('cookieSessionTime', 86400);
}
 ...
 */
$GLOBALS['TL_MODELS']['tl_ipaccess']          = AnyaccessHostModel::class;
$GLOBALS['TL_MODELS']['tl_anyaccess_session'] = AnyaccessSessionModel::class;
 ...
 */
$GLOBALS['TL_CRON']['minutely'][] = [Anyaccess::class, 'updateAllIps'];
 ...
 */
$GLOBALS['TL_HOOKS']['initializeSystem'][] = [GlobalIpAccess::class, 'initializeSystem'];
